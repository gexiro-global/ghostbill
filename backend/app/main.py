...
Lifespan: Redis, log redaction, audit table, background tasks (5), cleanup on shutdown.
"""
...
async def lifespan(app: FastAPI):
    ...
    # Start background tasks (5 total)
    ...
    logger.info(
        ...
        "detection_engine, webhook_worker, data_retention"
    )
    ...
    tasks = [price_task, expirer_task, detection_task, webhook_task, retention_task]
    for task in tasks:
        task.cancel()
