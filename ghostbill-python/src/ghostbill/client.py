...
class GhostBill:
    """Synchronous client for the GhostBill payment API."""
    ...
    def __repr__(self) -> str:
        return f"GhostBill(api_key={self._config.masked_key()!r}, base_url={self._config.base_url!r})"
